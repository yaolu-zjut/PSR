...
DATA_PATH = '/public/ly/zyt/xianyu/dataset/alldb/radio128/'
FILE_NAME = 'RML2016.10a_dict.pkl'

with open(DATA_PATH + FILE_NAME, 'rb') as fr:
    signal = pickle.load(fr, encoding='latin1')

# fr = open(DATA_PATH+FILE_NAME)
# signal = pickle.load(fr)
...
np.save(DATA_PATH+'radio128NormTrainX.npy',(Xtrain))
np.save(DATA_PATH+'radio128NormTrainSnrY.npy',(SNRtrain, Ytrain))
np.save(DATA_PATH+'radio128NormTestX.npy',(Xtest))
np.save(DATA_PATH+'radio128NormTestSnrY.npy',(SNRtest, Ytest))
